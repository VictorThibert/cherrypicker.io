...
try:
    ...
    for item in shots["resultSets"][0]["rowSet"]:
        ...
        add_shots = ("INSERT INTO playershots (UNIQUE_ID, GAME_ID, GAME_EVENT_ID, PLAYER_ID, PLAYER_NAME, TEAM_ID, TEAM_NAME, SHOT_TYPE, SHOT_DISTANCE, "
                     "LOC_X, LOC_Y, SHOT_MADE_FLAG) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) "
