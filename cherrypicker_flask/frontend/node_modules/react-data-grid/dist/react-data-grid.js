...
/***/ function(module, exports, __webpack_require__) {
	...
	var Row = React.createClass({
	  ...
	  onMouseEnter: function onMouseEnter() {
	  	this.props.onMouseEnter(this.props.idx, this.props.row)
...
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	    ...
	    return React.createElement(
	      'div',
	      _extends({}, this.getKnownDivProps(), { className: className, style: style, onDragEnter: this.handleDragEnter, onMouseEnter: this.onMouseEnter }),
	  ...
	  render: function render() {
	    ...
	    var rows = this.getRows(displayStart, displayEnd).map(function (r, idx) {
	      return _this3.renderRow({
	        ...
	        onMouseEnter: _this3.props.onMouseEnter
	      });
	    });
	    ...
	    var style = {
	      ...
	      left: 0,
	      overflowX: 'hidden',
	      overflowY: 'hidden', /* Victor changed this, this is not good, figure out a better way to do this*/
